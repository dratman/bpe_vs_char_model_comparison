...
# plots/current_run_smoothed.png and overwrites any previous snapshot.
#
# This script targets the *currently running* M3 BPE training. If a
# different M3 BPE run is started later, edit the LOG_NAME below or
# generalize this into a parameterized version.
